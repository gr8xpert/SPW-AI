...
export default function RsShareButtons({ url = '', title = '' }: Props) {
  ...
  return (
    <div class="rs-share-buttons">
      <a
        class="rs-share-buttons__btn rs-share-buttons__btn--whatsapp"
      ...
      <a
        class="rs-share-buttons__btn rs-share-buttons__btn--facebook"
      ...
      <a
        class="rs-share-buttons__btn rs-share-buttons__btn--twitter"
